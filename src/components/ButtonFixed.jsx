    ...
    <section className={'z-50 ' + props.className}>  
      <div className="bg-green-500  text-center text-white font-semibold drop-shadow-lg py-1 border-t-4 border-green-600">
        ...
        <div className='flex inline'>
            ...
            <a id="bt-whatsapp" className='self-center h-full px-5 py-3 hover:bg-green-400 ' href="https://soulshoes.mercadoshops.com.br/MLB-2750446878-chinelo-feminino-nuvem-ortopedica-eva-super-macio-off-_JM" target="_blank" rel="noreferrer">        
            <div className='flex'>
