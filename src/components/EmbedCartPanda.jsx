...
function EmbedCartPanda() {    
    ...
    return (<>
        ...
        <div className='flex p-3 pt-0 h4 text-center self-center md:flex-row'>

            <div id="cartpandaContainer" className="flex shrink w-fit flex-col justify-center bg-gray-100 m-5 mt-0 pb-2 md:m-0 rounded-2xl drop-shadow-xl md:basis-1/2">
            ...
            <img className="flex w-1/2 md:basis-1/2 bg-fill hidden md:flex px-4 object-contain" src={CoresNuvem} alt="Banner Gigante" />
        </div>
        </>  
        );
    }
