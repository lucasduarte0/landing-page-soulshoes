      ...
      <div className='py-4 relative max-w-6xl mx-auto px-4 sm:px-6'>
        <div className='md:pt-0'>
          ...
          {/* Section content */}
            ...
            <div class='flex-grow border border-gray-400 my-6'></div>
      

          <div className='md:grid-cols-2 md:gap-6'>
            {/* Content */}
            <div
              className=' w-full mx-auto md:col-span-7 lg:col-span-6 md:mt-6'
              data-aos='fade-right'
            >
              <div className='md:pr-4 lg:pr-12 xl:pr-16 mb-4'>
                <h3 className='h3'>Vantagens:</h3>
                {/* <p className="text-xl text-gray-600 text-sm">Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa.</p> */}
              </div>
              {/* Tabs buttons */}
              <div className='grid grid-cols-1 md:grid-cols-2 gap-1 mb-8 md:mb-0'>
                <a
                  className={`flex items-center text-lg p-4 rounded border transition duration-300 ease-in-out mb-3 ${
                    tab !== 1
                ...
                >
                  <div>
                    ...
                    <div className='text-gray-600 text-sm text-sm'>
                      Feito com uma camada de 3cm de E.V.A, o{" "}
                      <strong>Chinelo Nuvem</strong> vai te proporcionar maior
                      conforto para realizar as tarefas do seu dia!{" "}
                    </div>
                  </div>
                ...
                >
                  <div>
                    ...
                    <div className='text-gray-600 text-sm'>
                      Pesando apenas 150g, nosso <strong>Chinelo Nuvem</strong>{" "}
                      te acompanha em todas as ocasiões sem fazer feio! Seguro e
                      confiável!
                    </div>
                  </div>
                  <div className='flex justify-center items-center w-8 h-8 bg-white rounded-full shadow flex-shrink-0 ml-3'>
                ...
                >
                  <div>
                    ...
                    <div className='text-gray-600 text-sm'>
                      Nosso chinelo possui tecnologia antiderrapante que garante
                      o máximo atrito mesmo em pisos molhados!{" "}
                    </div>
                  </div>
                  <div className='flex justify-center items-center w-8 h-8 bg-white rounded-full shadow flex-shrink-0 ml-3'>
                    <svg
